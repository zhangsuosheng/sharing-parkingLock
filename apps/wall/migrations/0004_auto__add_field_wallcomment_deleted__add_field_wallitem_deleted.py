...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WallComment.deleted'
        db.add_column('wall_wallcomment', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'WallItem.deleted'
        db.add_column('wall_wallitem', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WallComment.deleted'
        db.delete_column('wall_wallcomment', 'deleted')

        # Deleting field 'WallItem.deleted'
        db.delete_column('wall_wallitem', 'deleted')
