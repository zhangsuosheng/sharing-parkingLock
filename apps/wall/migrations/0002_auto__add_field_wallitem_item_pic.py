...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WallItem.item_pic'
        db.add_column('wall_wallitem', 'item_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'WallItem.item_pic'
        db.delete_column('wall_wallitem', 'item_pic')
